23.845C101.556 24.9417 99.2345 25.49 96.6445 25.49ZM96.6445 19.75C97.8812 19.75 99.0012 19.4583 100.004 18.875C101.008 18.2917 101.801 17.475 102.384 16.425C102.968 15.3517 103.259 14.1267 103.259 12.75C103.259 11.3733 102.968 10.16 102.384 9.11C101.801 8.03667 101.008 7.20833 100.004 6.625C99.0012 6.04167 97.8812 5.75 96.6445 5.75C95.4078 5.75 94.2878 6.04167 93.2845 6.625C92.2812 7.20833 91.4878 8.03667 90.9045 9.11C90.3212 10.16 90.0295 11.3733 90.0295 12.75C90.0295 14.1267 90.3212 15.3517 90.9045 16.425C91.4878 17.475 92.2812 18.2917 93.2845 18.875C94.2878 19.4583 95.4078 19.75 96.6445 19.75ZM125.9 25.49C123.333 25.49 121.023 24.9533 118.97 23.88C116.94 22.7833 115.342 21.2667 114.175 19.33C113.008 17.3933 112.425 15.2 112.425 12.75C112.425 10.3 113.008 8.10667 114.175 6.17C115.342 4.23333 116.94 2.72833 118.97 1.655C121.023 0.558332 123.333 0.00999838 125.9 0.00999838C128.14 0.00999838 130.158 0.406666 131.955 1.2C133.752 1.99333 135.245 3.13667 136.435 4.63L132.025 8.62C130.438 6.70667 128.513 5.75 126.25 5.75C124.92 5.75 123.73 6.04167 122.68 6.625C121.653 7.20833 120.848 8.03667 120.265 9.11C119.705 10.16 119.425 11.3733 119.425 12.75C119.425 14.1267 119.705 15.3517 120.265 16.425C120.848 17.475 121.653 18.2917 122.68 18.875C123.73 19.4583 124.92 19.75 126.25 19.75C128.513 19.75 130.438 18.7933 132.025 16.88L136.435 20.87C135.245 22.3633 133.752 23.5067 131.955 24.3C130.158 25.0933 128.14 25.49 125.9 25.49ZM159.1 5.995H151.61V25H144.785V5.995H137.26V0.499998H159.1V5.995ZM162.295 0.499998H169.12V14.885L179.235 0.499998H185.745V25H178.92V10.65L168.84 25H162.295V0.499998Z" fill="#003268"/>
          </svg>
          ...
          <div class="news__wrapper news-list swiper-wrapper">
            <div class="news-list__item swiper-slide">
              <article class="news-list__article">
                <picture><source srcset="/public/images/news_photo.webp" type="image/webp"><img class="news-list__photo" src="/public/images/news_photo.jpg"  alt="Новостное фото" width="372px" height="272px"></picture>
  ...
  <section class="filling-museum">
    <div class="filling-museum__container">
      ...
      <div class="filling-museum__item filling-museum__item-1">
        <picture><source srcset="/public/images/filling_museum_photo_1.webp" type="image/webp"><img src="/public/images/filling_museum_photo_1.png" alt="1" width="100px" height="175px" class="filling-museum__item-photo filling-museum__photo-1"></picture>
        <p class="filling-museum__item-text filling-museum__text-1">Один из научно-технических музеев России — Политехнический музей
          Таганрогского технологического института ЮФУ — находится в Центральном районе Таганрога, недалеко от «Домика Чехова».
        </p>
      </div>
      <div class="filling-museum__item filling-museum__item-2">
        <picture><source srcset="/public/images/filling_museum_photo_2.webp" type="image/webp"><img src="/public/images/filling_museum_photo_2.png" alt="2"  width="531px" height="275px" class="filling-museum__item-photo filling-museum__photo-2"></picture>
      ...
      <div class="filling-museum__item filling-museum__item-3">
        <picture><source srcset="/public/images/filling_museum_photo_3.webp" type="image/webp"><img src="/public/images/filling_museum_photo_3.png" alt="3" width="484px" height="346px" class="filling-museum__item-photo filling-museum__photo-3"></picture>
      ...
      <div class="filling-museum__item filling-museum__item-4">
        <picture><source srcset="/public/images/filling_museum_photo_4.webp" type="image/webp"><img src="/public/images/filling_museum_photo_4.png" alt="4" width="320px" height="300px" class="filling-museum__item-photo filling-museum__photo-4"></picture>
      </div>
      <div class="filling-museum__item filling-museum__item-5">
        <picture><source srcset="/public/images/filling_museum_photo_5.webp" type="image/webp"><img src="/public/images/filling_museum_photo_5.png" alt="5" width="1120px" height="370px" class="filling-museum__item-photo filling-museum__photo-5"></picture>
  ...
  <section class="exposition-main">
    <div class="exposition-main__container">
      ...
      <p class="exposition-main__text">
        Экспозиция музея представляет собой историю развития науки и техники в направлениях, по которым будут готовить будущих специалистов Таганрогского технологического института:
      </p>
      <ul class="exposition-main__list exposition-list-main-page">
        <li class="exposition-list-main-page__item">
          <a href="#" class="exposition-list-main-page__link">
            <svg class="exposition-list-main-page__svg" role='img' aria-label='' focusable='false' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
              <use xlink:href='/public/sprite/icons.svg#expo_main_icon_1'></use>
            </svg>
        ...
        <li class="exposition-list-main-page__item">
          <a href="#" class="exposition-list-main-page__link">
            <svg class="exposition-list-main-page__svg" role='img' aria-label='' focusable='false' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
              <use xlink:href='/public/sprite/icons.svg#expo_main_icon_3'></use>
            </svg>
            <p class="exposition-list-main-page__text">
        ...
        <li class="exposition-list-main-page__item">
          <a href="#" class="exposition-list-main-page__link">
            <svg class="exposition-list-main-page__svg" role='img' aria-label='' focusable='false' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
              <use xlink:href='/public/sprite/icons.svg#expo_main_icon_4'></use>
            </svg>
            <p class="exposition-list-main-page__text">
  ...
  <section id="museum-contacts-section" class="museum-contacts">
    <div class="museum-contacts__container">
      <div class="museum-contacts__text-block text-block">
        ...
        <p class="text-block__time">
          <span class="text-block__bold-text">Время работы:</span>
          Пн-Пт: c 09:00-17:00
        </p>
        ...
        <p class="text-block__number">
          <span class="text-block__bold-text">Тел./факс:</span>
          +7 8634 371461
        </p>
        <a href="https://vk.com/id368810061" target="_blank" class="text-block__link-vk">
          <div class="text-block__icon-vk"></div>
        </a>
        <a href="https://sfedu.ru/" target="_blank" class="text-block__link-sfedu">
        <div class="text-block__icon-sfedu"></div>
        </a>
      </div>
      <button type="button" class="museum-contacts__btn-form btn-form">
        ЗАДАТЬ ВОПРОС
      </button>
    </div>
    <div id="yandex-map" class="museum-contacts__map"></div>
  </section>
  <div class="wrapper-modal visually-hidden">
    <section class="museum-contacts-form">
      <button type="button" class="museum-contacts-form__close"></button>
      <div class="museum-contacts-form__title">
        НАПИШИТЕ НАМ
      </div>
      <div class="museum-contacts-form__text">
      ...
      <form method="#" id="question-form-desktop" class="museum-contacts-form__question-form" name="user-questions" action="question.php">
        ...
        <p class="museum-contacts-form__submit-block">
          <button type="submit" id="question-submit-id" class="museum-contacts-form__submit btn-form"
            >Отправить</button>
        </p>
      </form>
  ...
  <section class="museum-contacts-mobile-form">
    ...
    <form id="form-mobile-question" class="museum-contacts-mobile-form__question-form" name="user-questions-mobile" action="question-form" method="GET">
